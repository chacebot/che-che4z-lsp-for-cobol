...
cics_inquire_system: INQUIRE (cics_inquire_association | cics_inquire_association_list | cics_inquire_atomservice | cics_inquire_urimap);
...
cicsLexerDefinedVariableUsageTokens: ABCODE | ABDUMP | ABEND | ABORT | ABPROGRAM | ABSTIME | ACAPPLNAME | ACCUM | ACEE | ACMAJORVER
    ...
    | ASRASTG | ASSOCIATION | ASYNCHRONOUS | ATOMTYPE | ATTACH | ATTACHID | ATTRIBUTES | AUTHENTICATE | AUTOPAGE | AUXILIARY | BASE64
    | BASICAUTH | BELOW | BIF | BINDFILE | BODYCHARSET | BOOKMARK | BRDATA | BRDATALENGTH | BREXIT | BRIDGE | BROWSETOKEN
    ...
    | LINKAGE | LINKLEVEL | LIST | LISTLENGTH | LISTSIZE | LLID | LOAD | LOCATION | LOCALCCSID | LOCALITY | LOCALITYLEN
    ...
    | MINUTES | MMDDYY | MMDDYYYY | MODENAME | MONITOR | MONTH | MONTHOFYEAR | MSR | MSRCONTROL | MVSIMAGE | NAME | NAMELENGTH
    ...
    | SYNCLEVEL | SYNCONRETURN | SYNCPOINT | SYSID | TABLES | TASK | TASKPRIORITY | TCPIP | TCPIPJOB | TCPIPSERVICE | TCPIPZONE | TCT | TCTUA
