...
cics_inquire_system: INQUIRE (cics_inquire_association | cics_inquire_urimap);
...
cicsLexerDefinedVariableUsageTokens: ABCODE | ABDUMP | ABEND | ABORT | ABPROGRAM | ABSTIME | ACAPPLNAME | ACCUM | ACEE | ACMAJORVER
    ...
    | ASRASTG | ASSOCIATION | ASYNCHRONOUS | ATTACH | ATTACHID | ATTRIBUTES | AUTHENTICATE | AUTOPAGE | AUXILIARY | BASE64
