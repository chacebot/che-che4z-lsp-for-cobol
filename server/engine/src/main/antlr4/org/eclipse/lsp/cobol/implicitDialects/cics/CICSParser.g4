...
cics_inquire_system: INQUIRE (cics_inquire_association | cics_inquire_association_list | cics_inquire_atomservice | cics_inquire_autinstmodel | cics_inquire_autoinstall | cics_inquire_brfacility);
...
cicsLexerDefinedVariableUsageTokens: ABCODE | ABDUMP | ABEND | ABORT | ABPROGRAM | ABSTIME | ACAPPLNAME | ACCUM | ACEE | ACMAJORVER
    ...
    | BASICAUTH | BELOW | BIF | BINDFILE | BODYCHARSET | BOOKMARK | BRDATA | BRDATALENGTH | BREXIT | BRFACILITY | BRIDGE | BROWSETOKEN
    ...
    | MAXPROCLEN | MAXREQS | MCC | MEDIATYPE | MESSAGEID | METADATA | METADATALEN | METHODLENGTH | MILLISECONDS | MINIMUM
    | MINUTES | MMDDYY | MMDDYYYY | MODENAME | MONITOR | MONTH | MONTHOFYEAR | MSR | MSRCONTROL | MVSIMAGE | NAME | NAMELENGTH | NAMESPACE
    ...
    | SYNCLEVEL | SYNCONRETURN | SYNCPOINT | SYSID | TABLES | TASK | TASKID | TASKPRIORITY | TCPIP | TCPIPJOB | TCPIPSERVICE | TCPIPZONE | TCT | TCTUA
