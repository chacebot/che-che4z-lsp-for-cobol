...
cicsLexerDefinedVariableUsageTokens: ABCODE | ABDUMP | ABEND | ABORT | ABPROGRAM | ABSTIME | ACAPPLNAME | ACCUM | ACEE | ACMAJORVER
    ...
    | ACQACTIVITY | ACQPROCESS | ACQUACTIVITY | ACTION | ACTIVITY | ACTIVITYID | ACTPARTN | AIBRIDGE | AID | ALARM | ALTSCRNHT | ALTSCRNWD
    | ANYKEY | APLKYBD | APLTEXT | APPLDATA | APPLID | AS | ASA | ASIS | ASKTIME | ASRAINTRPT | ASRAKEY | ASRAPSW | ASRAREGS | ASRASPC
    | ASRASTG | ASSOCIATION | ASYNCHRONOUS | ATOMTYPE | ATTACH | ATTACHID | ATTRIBUTES | AUTHENTICATE | AUTINSTMODEL | AUTOINSTALL | AUTOPAGE | AUXILIARY | BASE64
    | BASESCOPE | BASICAUTH | BELOW | BIF | BINDFILE | BODYCHARSET | BOOKMARK | BRDATA | BRDATALENGTH | BREXIT | BRFACILITY | BRIDGE | BROWSETOKEN
    | BTRANS | BUFFER | BUILD | BUNDLE | BUNDLEDIR | BUNDLEID | BURGEABILITY | CADDRLENGTH | CARD | CBUFF | CCSID | CERTIFICATE | CHANGE | CHANGETIME
    | CHANNEL | CHAR | CHARACTERSET | CHECK | CHUNKEND | CHUNKING | CHUNKNO | CHUNKYES | CICSDATAKEY | CIPHERS | CLEAR
    | CLICONVERT | CLIENT | CLIENTADDR | CLIENTADDRNU | CLIENTCONV | CLIENTIPADDR | CLNTCODEPAGE | CLIENTNAME | CLIENTPORT | CLNTADDR6NU | CLNTIPFAMILY
    | CLOSESTATUS | CLRPARTN | CMDSEC | CNAMELENGTH | CNOTCOMPL | CODEPAGE | COLOR | COMMAREA | COMMONNAME
    | COMMONNAMLEN | COMPAREMAX | COMPAREMIN | COMPLETE | COMPOSITE | COMPSTATUS | CONFIGFILE | CONFIRM | CONFIRMATION | CONNECT
    | CONSISTENT | CONSOLE | CONSOLES | CONTAINER | CONTEXTTYPE | CONVDATA | CONVERSE | CONVERTST | CONVERTTIME | CONVID
    | COUNTER | COUNTRY | COUNTRYLEN | CREATE | CRITICAL | CTLCHAR | CURRENT | CURREQS | CWA | CWALENG | DATA1 | DATA2
    ...
    | DNAME | DNAMELEN | DOCDELETE | DOCSIZE | DOCSTATUS | DOCTOKEN | DOCUMENT | DS3270 | DSSCS | DUMP | DUMPCODE | DUMPID | DUPREC
    | ECADDR | ECBLIST | EIB | ELEMNAME | ELEMNAMELEN | ELEMNS | ELEMNSLEN | ENABLEDCOUNT | ENDACTIVITY | ENDBR | ENDBROWSE | ENDFILE
    ...
    | EXTRACT | FACILITY | FACILITYTOKN | FACILNAME | FACILTYPE | FAULTACTLEN | FAULTACTOR | FAULTCODE | FAULTCODELEN | FAULTCODESTR
    ...
    | HTTPVNUM | IGNORE | IMMEDIATE | INCREMENT | INITIMG | INITPARM | INITPARMLEN | INITUSERID | INPARTN | INPUTEVENT | INPUTMSG
    | INPUTMSGLEN | INQUIRE | INTEGER | INTERVAL | INTOCCSID | INTOCODEPAGE | INVALIDCOUNT | INVITE | INVMPSZ | INVOKE
    | INVOKINGPROG | INVPARTN | INVREQ | IPCONN | ISSUE | ISSUER | ITEM | IUTYPE | JOURNALNAME | JTYPEID | JUSFIRST | JUSLAST
    | JUSTIFY | KATAKANA | KEEP | KEEPTIME| KEYLENGTH | KEYNUMBER | L40 | L64 | L80 | LANGINUSE | LANGUAGECODE | LASTUSETIME
    | LDC | LDCMNEM | LDCNUM | LEAVEKB | LENGTHLIST | LEVEL | LIGHTPEN | LINAGE_COUNTER | LINEADDR | LINK
    | LINKAGE | LINKLEVEL | LINKSYSNET | LINKSYSTEM | LIST | LISTLENGTH | LISTSIZE | LLID | LOAD | LOCATION | LOCALCCSID | LOCALITY | LOCALITYLEN
    ...
    | MAXPROCLEN | MAXREQS | MCC | MEDIATYPE | MESSAGEID | METADATA | METADATALEN | METHODLENGTH | MGMTPART | MICROVERSION | MILLISECONDS | MINIMUM
    | MINORVERSION | MINUTES | MMDDYY | MMDDYYYY | MODENAME | MONITOR | MONTH | MONTHOFYEAR | MSR | MSRCONTROL | MVSIMAGE | NAME | NAMELENGTH | NAMESPACE
    | NATLANG | NATLANGINUSE | NETID | NETNAME | NEWPASSWORD | NEWPHRASE | NEWPHRASELEN | NEXTTRANSID | NLEOM | NOAUTOPAGE
    ...
    | NUMTAB | ODADPTRDATA1 | ODADPTRDATA2 | ODADPTRDATA3 | ODADPTRID | ODAPPLID | ODCLNTPORT | ODFACILNAME | ODFACILTYPE | ODIPFAMILY | ODLUNAME| ODNETID
    | ODNETWORKID | ODSERVERPORT | ODSTARTTIME | ODTASKID | ODTCPIPS | ODTRANSID | ODUSERID | OIDCARD | OPCLASS | OPERATION | OPERATOR
    | OPERID | OPERKEYS | OPERPURGE | OPID | OPSECURITY
    | OPTIONS | ORGABCODE | ORGANIZATLEN | ORGUNIT | ORGUNITLEN | OUTDESCR | OUTLINE | OUTPARTN | OWNER | PA1 | PA2
    | PA3 | PAGENUM | PAGE_COUNTER | PAGING | PARSE | PARTCOUNT | PARTN | PARTNER | PARTNFAIL | PARTNPAGE | PARTNS | PARTNSET
    ...
    | PHAPPLID | PHCOUNT | PHNETWORKID
    | PHRASE | PHRASELEN | PHSTARTTIME | PHTASKID | PHTRANSID | PIPLENGTH | PIPLIST | POINT | POOL | POP | PORTNUMBER | PORTNUMNU | POST | PPT | PREDICATE
    | PREFIX | PREPARE | PRINCONVID | PRINSYSID | PRINT | PRIORITY | PRIVACY | PROCESS | PROCESSTYPE | PROCLENGTH
    | PROCNAME | PROFILE | PROTECT | PS | PTCOUNT | PTSTARTTIME | PTTASKID | PTTRANSID | PUNCH | PURGEABLE | PUSH | PUT | QNAME | QUERY | QUERYPARM | QUERYSTRING
    | QUERYSTRLEN | RBA | RBN | RDATT | READNEXT | READPREV | READQ | REATTACH | RECEIVER | RECFM | RECORDLEN
    | RECORDLENGTH | REDUCE | REFPARMS | REFPARMSLEN | RELATESINDEX | RELATESTYPE | RELATESURI | REMOTESYSNET | REMOTESYSTEM | REMOVE | REPEATABLE
    | RESOURCENAME | RESOURCETYPE | REPETABLE | REPLY | REPLYLENGTH | REQID | REQUESTTYPE | RESCLASS | RESETBR | RESID | RESIDLENGTH | RESOURCE
    ...
    | SENDER | SERIALNUM | SERIALNUMLEN | SERVER | SERVERADDR | SERVERADDRNU | SERVERCONV | SERVERIPADDR | SERVERNAME | SERVERPORT | SESSION
    ...
    | STARTCODE | STARTTIME | STATE | STATELEN | STATIONID | STATUSCODE | STATUSLEN | STATUSTEXT | STORAGE | STRFIELD
    ...
    | SYNCLEVEL | SYNCONRETURN | SYNCPOINT | SYSID | TABLES | TARGETCOUNT | TASK | TASKID | TASKPRIORITY | TCPIP | TCPIPJOB | TCPIPSERVICE | TCPIPZONE | TCT | TCTUA
    | TCTUALENG | TD | TELLERID | TEMPLATE | TERMCODE | TERMID | TERMPRIORITY | TERMSTATUS | TEXTKYBD | TEXTLENGTH | TEXTPRINT
    | TIMEOUT | TIMER | TIMESEP | TOACTIVITY | TOCHANNEL | TOCONTAINER | TOFLENGTH | TOKEN | TOLENGTH | TOPROCESS
    | TRACENUM | TRAILER | TRANPRIORITY | TRANSACTION | TRANSFORM | TRANSID | TRIGGER | TRNGRPID | TRT | TS | TWA | TWALENG
    | TYPENAME | TYPENAMELEN | TYPENS | TYPENSLEN | UNATTEND | UNCOMMITTED | UNESCAPED | UNEXPIN | UNLOCK | UOW
    | UPDATE | URI | URIMAP | URL | URLLENGTH | USERCORRDATA | USERDATAKEY | USERID | USERNAME | USERNAMELEN | USERPRIORITY
